...
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst configLoader_1 = __webpack_require__(/*! ./configLoader */ \"./frontend/src/scripts/configLoader.ts\");\nconst fileFetcher_1 = __webpack_require__(/*! ./fileFetcher */ \"./frontend/src/scripts/fileFetcher.ts\");\n__webpack_require__(/*! ../style.css */ \"./frontend/src/style.css\");\nfunction main() {\n    return __awaiter(this, void 0, void 0, function* () {\n        yield (0, configLoader_1.loadConfig)();\n        (0, fileFetcher_1.fetchFiles)();\n        const orderRadios = document.querySelectorAll('input[name=\"order\"]');\n        orderRadios.forEach(radio => {\n            radio.addEventListener('change', () => (0, fileFetcher_1.fetchFiles)());\n        });\n    });\n}\nwindow.onload = main;\n\n\n//# sourceURL=webpack://rbs2/./frontend/src/scripts/main.ts?");
